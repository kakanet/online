...
message = "<b>dari: "+ $("#namapemberi").val() +" %0Anopc: " + $("#nopcpemberi").val() +" %0Ake: " + $("#namadiberi").val() +" %0Anopc: " + $("#nopcdiberi").val() +" %0Awaktu: "+ $("#waktudiberi").val() +" </b>%0A------------------------------------------------------------ %0AHallo "+ $("#namapemberi").val() +" %0Akamu berhasil %0Amemberi waktu ke "+ $("#namadiberi").val() +" %0Asebanyak "+ $("#waktudiberi").val() +"  %0Amakasih"
