...
message = "<b>nama: "+ $("#nama").val() +" %0Anopc: " + $("#nopc").val() +" %0Aalamat: " + $("#rumah").val() +" %0Abaju: " + $("#warnabaju").val() +" %0Adaftar member</b>%0A------------------------------------------------------------ %0AHallo "+ $("#nama").val() +" %0Akamu berhasil mendaftar member  %0Aid: "+ $("#nama").val() +" %0Apassword: penjaga yg mengisi %0Amakasih"
