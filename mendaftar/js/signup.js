...
message = "<b>DAFTAR HOTSPOT PC</b>%0AHallo "+ $("#nama").val() +" %0A------------------------------------------------------------ %0Akamu berhasil mendaftar hotspot  %0Aisi nama kamu yaitu: "+ $("#nama").val() +" %0Asilahkan login %0A. %0A%0Anomorpc : " + $("#nomorpc").val();
