...
message = "<b>NO: " + $("#nomorpc").val() +" DAFTAR HOTSPOT DARI PC</b>%0A------------------------------------------------------------%0Akamu berhasil mendaftar hotspot  %0Anama: "+ $("#nama").val() +" %0Aperhatikan huruf besar atau kecil %0Asilahkan login %0A" + $("#nama").val()
