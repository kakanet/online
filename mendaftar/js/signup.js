...
message = "<b>NO: " + $("#nomorpc").val() +" DAFTAR HOTSPOT</b>%0A------------------------------------------------------------ %0AHallo "+ $("#nama").val() +" %0Akamu berhasil mendaftar hotspot  %0Aisi nama kamu yaitu: "+ $("#nama").val() +" %0Asilahkan login %0A" + $("#nama").val()
