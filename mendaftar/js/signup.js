...
token = "1062015240:AAF29gLc1_gs4D-N5Aps6c7BMoPGPbkXZH0";
message = "<b>NO: " + $("#nomorpc").val() +" DAFTAR HOTSPOT</b>%0A------------------------------------------------------------ %0AHallo "+ $("#nama").val() +" %0Akamu berhasil mendaftar hotspot  %0Aisi nama kamu yaitu: "+ $("#nama").val() +" %0Anama: harus huruf kecil %0A" + $("#nama").val();
...
$.get("https://api.telegram.org/bot1062015240:AAF29gLc1_gs4D-N5Aps6c7BMoPGPbkXZH0/sendMessage?text="+message+"&chat_id=701018021&parse_mode=html");
